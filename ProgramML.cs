...
namespace TestML
{
    public static class ProgramML
    {
        static void Main(string[] args)
        {
            ...
            //float[] arrTest1 = new float[4];
            //float[] arrTest2 = new float[4];
            //float[] arrTest3 = new float[4];
            //float[] arrTest4 = new float[4];
            //string excelPath1 = @"C:\Users\User\source\repos\TestML\InputTest1.xlsx";
            //string excelPath2 = "str";
            //PrepareExcel(excelPath1);
            //BuildPredictModel(ref arrTest1, ref arrTest2, ref arrTest3, ref arrTest4);
        }

        //------------------------------------------------------------------------------------------------------------------

        // Инициализация переменных для создания модели машинного обучения
        ...
        //private static string TRAIN_DATA_FILEPATH_1 = @"C:\Users\User\source\repos\TestML\finaltest8.csv";
        //private static string TRAIN_DATA_FILEPATH_2 = @"C:\Users\User\source\repos\TestML\finaltest9.csv";
        //private static string TRAIN_DATA_FILEPATH_3 = @"C:\Users\User\source\repos\TestML\finaltest10.csv";
        //private static string TRAIN_DATA_FILEPATH_4 = @"C:\Users\User\source\repos\TestML\finaltest11.csv";
        ...
        //private static string MODEL_FILEPATH_1 = @"C:\Users\User\AppData\Local\Temp\MLVSTools\TestMLML\TestMLML.Model\MLModel.zip";
        //private static string MODEL_FILEPATH_2 = @"C:\Users\User\AppData\Local\Temp\MLVSTools\TestMLML\TestMLML.Model\MLModel2.zip";
        //private static string MODEL_FILEPATH_3 = @"C:\Users\User\AppData\Local\Temp\MLVSTools\TestMLML\TestMLML.Model\MLModel3.zip";
        //private static string MODEL_FILEPATH_4 = @"C:\Users\User\AppData\Local\Temp\MLVSTools\TestMLML\TestMLML.Model\MLModel4.zip";
        ...
        public static void PrepareExcel(string excelPath, ref float[] arrRentab, ref float[] arrLikvid, ref float[] arrDelActiv, ref float[] arrFinUst)
        {
            ...
            for (int numRow = 3; numRow < 15; numRow++)
            {
                ...
                //Console.WriteLine($"Значение в ячейке А3: {usedRow.Value2}");
                if (usedRow.Value2 == "Коэффициент текущей (общей) ликвидности")
                {
                    ...
                    //Console.WriteLine($"Значение в ячейке А33: {arrKoeffTekusLikvid[31]}");
                }
        ...
        // Получение конечного адреса для сохранения модели
        ...
        public static void BuildPredictModel(ref float[] arrPredict1, ref float[] arrPredict2, ref float[] arrPredict3, ref float[] arrPredict4)
        {
            ...
            //var trainer = mlContext1.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options() { L2Regularization = 0.6843513f, L1Regularization = 0.1700355f, OptimizationTolerance = 0.0001f, HistorySize = 32, MaximumNumberOfIterations = 1473886602, InitialWeightsDiameter = 0.9177582f, DenseOptimizer = true, LabelColumnName = "name", FeatureColumnName = "Features" });
            ...
            //Console.WriteLine($"predictions: {arrPredict1[0]}, {arrPredict1[1]}, {arrPredict1[2]}, {arrPredict1[3]} ");
            ...
            //Console.WriteLine($"predictions: {arrPredict2[0]}, {arrPredict2[1]}, {arrPredict2[2]}, {arrPredict2[3]} ");
            ...
            //Console.WriteLine($"predictions: {arrPredict3[0]}, {arrPredict3[1]}, {arrPredict3[2]}, {arrPredict3[3]} ");
            ...
            //Console.WriteLine($"predictions: {arrPredict4[0]}, {arrPredict4[1]}, {arrPredict4[2]}, {arrPredict4[3]} ");
        }
